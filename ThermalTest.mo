...
package ThermalTest
  model ControlledTemperature "Control temperature of a resistor"
    ...
    parameter Modelica.Units.SI.Temperature TAmb(displayUnit="degC")=293.15
      "Ambient temperature";
    parameter Modelica.Units.SI.TemperatureDifference TDif=2
      "Error in temperature";
    output Modelica.Units.SI.Temperature TRes(displayUnit="degC")=resistor.T_heatPort
    ...
    Modelica.Electrical.Analog.Basic.Resistor resistor(
      ...
      useHeatPort=true) annotation (Placement(transformation(
          ...
          extent={{-10,10},{10,-10}},
          rotation=270)));
    Modelica.Thermal.HeatTransfer.Sources.FixedTemperature fixedTemperature(T=TAmb)
    ...
    Modelica.Blocks.Sources.Ramp ramp(
      ...
      duration=6,
      offset=25,
      startTime=2) annotation (Placement(transformation(extent={{60,42},{40,62}})));
  ...
  equation
    ...
    connect(ramp.y, onOffController.reference) annotation (Line(points={{39,52},
            {2,52},{2,-4}},              color={0,0,127}));
